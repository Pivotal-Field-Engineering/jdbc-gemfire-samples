...
CREATE PROCEDURE dbo.csvloader (
    in filePath varchar(200), in schemaName varchar(100), in tableName varchar(100), in delimiter varchar(1))
    language java parameter style java modifies sql data
...
CREATE TABLE dbo.appointment (
    ...
    parrs_appt_id varchar(250) NOT NULL ,
    ...
    appt_type_code varchar(10) NOT NULL,
...
CREATE UNIQUE INDEX NDX_APPOINTMENT_parrs_appt_id ON dbo.appointment (parrs_appt_id);
