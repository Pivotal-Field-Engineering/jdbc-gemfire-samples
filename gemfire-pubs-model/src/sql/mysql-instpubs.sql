...
CREATE TABLE jobs
(
   job_id         smallint		  GENERATED ALWAYS AS IDENTITY		 PRIMARY KEY ,
...
(
   ...
   job_id         smallint          NOT NULL	WITH	DEFAULT 1	 REFERENCES jobs(job_id),
   job_lvl        SMALLINT				WITH DEFAULT 10,
